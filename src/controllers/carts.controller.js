...
const purchaseCart = async (req, res) => {
    ...
    try {
        ...
        if (cart) {
            ...
            const userRole = user[0].rol; // Accediendo al rol del usuario
            ...
            cart.products.forEach(async item => {
                const product = products.find(prod => prod._id == item.id_prod._id.toString());
            ...
            if (userRole === 'premium') { // Aplicando descuento al usuario premium
                amount *= 0.9;
            }
